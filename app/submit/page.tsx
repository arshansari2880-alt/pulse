      ...
      <article className="mx-auto max-w-[720px] px-6 py-12 md:px-0">
        ...
        <section className="mt-8 rounded-sheet border border-white/[0.08] bg-bg-2 p-5">
          ...
          <ul className="mt-3 space-y-2 text-[14px]">
            <li>
              Live prototype:{" "}
              <a className="text-accent" href="https://pulse-map.onrender.com">
                https://pulse-map.onrender.com
              </a>
            </li>
            <li>
              GitHub:{" "}
            ...
            <li>
              Design thinking:{" "}
              <a className="text-accent" href="https://pulse-map.onrender.com/thinking">
                /thinking
              </a>
            </li>
          </ul>
